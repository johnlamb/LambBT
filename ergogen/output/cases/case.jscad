function standoff_extrude_4_outline_fn(){
    return CAG.circle({"center":[229.2956862,-158.5789365],"radius":2.5,"resolution":158})
.union(
    CAG.circle({"center":[196.810495,-97.7948399],"radius":2.5,"resolution":158})
).union(
    CAG.circle({"center":[157.2004773,-138.2355142],"radius":2.5,"resolution":158})
).union(
    CAG.circle({"center":[153.3181916,-123.7466269],"radius":2.5,"resolution":158})
).extrude({ offset: [0, 0, 4] });
}


function mounting_extrude_4_outline_fn(){
    return CAG.circle({"center":[229.2956862,-158.5789365],"radius":1.5,"resolution":95})
.union(
    CAG.circle({"center":[196.810495,-97.7948399],"radius":1.5,"resolution":95})
).union(
    CAG.circle({"center":[157.2004773,-138.2355142],"radius":1.5,"resolution":95})
).union(
    CAG.circle({"center":[153.3181916,-123.7466269],"radius":1.5,"resolution":95})
).extrude({ offset: [0, 0, 4] });
}


function _case_xlplate_extrude_1_outline_fn(){
    return new CSG.Path2D([[149.7665976,-102.4398357],[126.9861768,-108.5438311]]).appendArc([126.27907,-109.7685759],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([140.86223,-164.1936696]).appendArc([141.3455608,-164.8106942],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendArc([242.6229497,-179.7295169],{"radius":147.5,"clockwise":true,"large":false,"resolution":9268}).appendArc([242.8171099,-179.4888435],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([253.3655011,-161.2184942]).appendArc([253.4956704,-160.8056499],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([258.0807313,-108.3981643]).appendArc([257.1760528,-107.315205],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([237.78759,-105.5333686]).appendArc([236.8829115,-104.4504093],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([238.3649399,-87.5107476]).appendArc([237.4559009,-86.4273972],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([221.5167858,-85.0329052]).appendArc([220.6077468,-83.9495548],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([220.6803766,-83.1193926]).appendArc([219.7713376,-82.0360422],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([198.5094557,-80.1758686]).appendArc([197.5988254,-79.2461808],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([197.3865084,-76.0608436]).appendArc([196.3887224,-75.1273505],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([173.2990448,-75.1273505]).appendArc([172.2993715,-76.1017899],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([172.1794864,-80.7904907]).appendArc([171.2669688,-81.7611248],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([150.4126338,-83.5856426]).appendArc([149.5015778,-84.6416146],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([150.5059903,-101.4141326]).appendArc([149.7665976,-102.4398357],{"radius":1,"clockwise":true,"large":false,"resolution":63}).close().innerToCAG()
.extrude({ offset: [0, 0, 1] });
}


function _case_xlplate_extrude_7_2_outline_fn(){
    return new CSG.Path2D([[149.7665976,-102.4398357],[126.9861768,-108.5438311]]).appendArc([126.27907,-109.7685759],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([140.86223,-164.1936696]).appendArc([141.3455608,-164.8106942],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendArc([242.6229497,-179.7295169],{"radius":147.5,"clockwise":true,"large":false,"resolution":9268}).appendArc([242.8171099,-179.4888435],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([253.3655011,-161.2184942]).appendArc([253.4956704,-160.8056499],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([258.0807313,-108.3981643]).appendArc([257.1760528,-107.315205],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([237.78759,-105.5333686]).appendArc([236.8829115,-104.4504093],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([238.3649399,-87.5107476]).appendArc([237.4559009,-86.4273972],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([221.5167858,-85.0329052]).appendArc([220.6077468,-83.9495548],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([220.6803766,-83.1193926]).appendArc([219.7713376,-82.0360422],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([198.5094557,-80.1758686]).appendArc([197.5988254,-79.2461808],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([197.3865084,-76.0608436]).appendArc([196.3887224,-75.1273505],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([173.2990448,-75.1273505]).appendArc([172.2993715,-76.1017899],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([172.1794864,-80.7904907]).appendArc([171.2669688,-81.7611248],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([150.4126338,-83.5856426]).appendArc([149.5015778,-84.6416146],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([150.5059903,-101.4141326]).appendArc([149.7665976,-102.4398357],{"radius":1,"clockwise":true,"large":false,"resolution":63}).close().innerToCAG()
.extrude({ offset: [0, 0, 7.2] });
}


function _case_pcb_extrude_7_2_outline_fn(){
    return new CSG.Path2D([[152.2024531,-103.8577026],[129.4356666,-109.9580447]]).appendArc([128.7285598,-111.1827895],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([142.2765168,-161.7444527]).appendArc([142.9506171,-162.4421053],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendArc([241.8431768,-177.0379677],{"radius":149.5,"clockwise":true,"large":false,"resolution":9394}).appendArc([242.0852038,-176.7565421],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([251.6334503,-160.2184942]).appendArc([251.7636196,-159.8056499],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([256.1086163,-110.1421103]).appendArc([255.1995185,-109.0587548],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([235.6256943,-107.3474321]).appendArc([234.7165965,-106.2640766],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([236.1982391,-89.3288255]).appendArc([235.2892001,-88.2454751],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([219.350085,-86.8509831]).appendArc([218.441046,-85.7676326],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([218.5136757,-84.9374706]).appendArc([217.6046367,-83.8541201],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([196.3709377,-81.9964121]).appendArc([195.4586845,-81.0345941],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([195.3575015,-78.0929738]).appendArc([194.3580926,-77.1273505],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([175.3241414,-77.1273505]).appendArc([174.3241414,-78.127205],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([174.3234927,-82.5851676]).appendArc([173.4106484,-83.5812168],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([152.5957879,-85.4022811]).appendArc([151.6858792,-86.4750439],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([152.9406985,-102.8152087]).appendArc([152.2024531,-103.8577026],{"radius":1,"clockwise":true,"large":false,"resolution":63}).close().innerToCAG()
.extrude({ offset: [0, 0, 7.2] });
}


function _case_pcb_extrude_4_outline_fn(){
    return new CSG.Path2D([[152.2024531,-103.8577026],[129.4356666,-109.9580447]]).appendArc([128.7285598,-111.1827895],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([142.2765168,-161.7444527]).appendArc([142.9506171,-162.4421053],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendArc([241.8431768,-177.0379677],{"radius":149.5,"clockwise":true,"large":false,"resolution":9394}).appendArc([242.0852038,-176.7565421],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([251.6334503,-160.2184942]).appendArc([251.7636196,-159.8056499],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([256.1086163,-110.1421103]).appendArc([255.1995185,-109.0587548],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([235.6256943,-107.3474321]).appendArc([234.7165965,-106.2640766],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([236.1982391,-89.3288255]).appendArc([235.2892001,-88.2454751],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([219.350085,-86.8509831]).appendArc([218.441046,-85.7676326],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([218.5136757,-84.9374706]).appendArc([217.6046367,-83.8541201],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([196.3709377,-81.9964121]).appendArc([195.4586845,-81.0345941],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([195.3575015,-78.0929738]).appendArc([194.3580926,-77.1273505],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([175.3241414,-77.1273505]).appendArc([174.3241414,-78.127205],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([174.3234927,-82.5851676]).appendArc([173.4106484,-83.5812168],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([152.5957879,-85.4022811]).appendArc([151.6858792,-86.4750439],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([152.9406985,-102.8152087]).appendArc([152.2024531,-103.8577026],{"radius":1,"clockwise":true,"large":false,"resolution":63}).close().innerToCAG()
.extrude({ offset: [0, 0, 4] });
}


function _case_inner_pcb_extrude_4_outline_fn(){
    return new CSG.Path2D([[153.2983349,-104.4958105],[130.537937,-110.5944408]]).appendArc([129.8308302,-111.8191856],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([142.9129468,-160.6423089]).appendArc([143.7296164,-161.3722885],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([143.7366496,-161.3733501]).appendArc([241.4835751,-175.8316507],{"radius":150.4,"clockwise":true,"large":false,"resolution":9450}).appendArc([241.7558483,-175.5270028],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([250.6540275,-160.1149043]).appendArc([250.7841968,-159.70206],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([255.0465254,-110.9834206]).appendArc([254.1389133,-109.9001961],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([234.6490633,-108.1669209]).appendArc([233.7414512,-107.0836964],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([235.2232237,-90.1469606]).appendArc([234.3141847,-89.0636102],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([218.3750696,-87.6691182]).appendArc([217.4660306,-86.5857677],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([217.5386603,-85.7556056]).appendArc([216.6296213,-84.6722551],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([195.4096235,-82.8157458]).appendArc([194.4969609,-81.8386159],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([194.4429916,-79.0082857]).appendArc([193.4431733,-78.0273505],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([176.2361309,-78.0273505]).appendArc([175.2362002,-79.0391243],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([175.2874579,-83.392344]).appendArc([174.3746829,-84.4003125],{"radius":1,"clockwise":true,"large":false,"resolution":63}).appendPoint([153.5785278,-86.2197403]).appendArc([152.6692472,-87.3002839],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([154.0359522,-103.4455358]).appendArc([153.2983349,-104.4958105],{"radius":1,"clockwise":true,"large":false,"resolution":63}).close().innerToCAG()
.extrude({ offset: [0, 0, 4] });
}


function _usbcutout_extrude_8_outline_fn(){
    return new CSG.Path2D([[240.9587177,-115.2322992],[246.9358859,-115.7552336]]).appendArc([248.0192363,-114.8461946],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([248.7164823,-106.8766371]).appendArc([247.8074433,-105.7932866],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([241.8302751,-105.2703522]).appendArc([240.7469247,-106.1793912],{"radius":1,"clockwise":false,"large":false,"resolution":63}).appendPoint([240.0496787,-114.1489487]).appendArc([240.9587177,-115.2322992],{"radius":1,"clockwise":false,"large":false,"resolution":63}).close().innerToCAG()
.extrude({ offset: [0, 0, 8] });
                ...
                let _xlbottom__part_0 = _case_xlplate_extrude_1_outline_fn();
                ...
                let _outerWall__part_0 = _case_xlplate_extrude_7_2_outline_fn();
                ...
                let _innerWall__part_0 = _case_pcb_extrude_7_2_outline_fn();
                ...
                let _outerShelf__part_0 = _case_pcb_extrude_4_outline_fn();
                ...
                let _innerShelf__part_0 = _case_inner_pcb_extrude_4_outline_fn();
                ...
                let _usbcutout_case__part_0 = _usbcutout_extrude_8_outline_fn();
                ...
                _usbcutout_case__part_0 = translate([0,0,4], _usbcutout_case__part_0);
